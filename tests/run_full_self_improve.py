...
print("\n=== FULL CYCLE COMPLETE ===")
print(f"Repos evaluated: {result['repos_evaluated']}")
print(f"Approved: {len(result['approved'])}")
print(f"Implemented: {len(result['implemented'])}")
for impl in result['implemented']:
    print(f"  Files created: {impl['files_created']}")
    print(f"  Tests added: {impl['tests_added']}")
